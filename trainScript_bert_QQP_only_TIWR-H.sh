...
# nohup ./trainScript_bert_QQP_only_TIWR-H.sh > /dev/null 2>&1 &
# nohup autocuda.sh -bo /dev/null "nohup ./trainScript_bert_QQP_only_TIWR-H.sh" > autocuda.log 2>&1 &
