...
# nohup ./trainScript_bert_MRPC_only_TIWR-H.sh > /dev/null 2>&1 &
# nohup autocuda.sh -bo /dev/null "nohup ./trainScript_bert_MRPC_only_TIWR-H.sh" > autocuda.log 2>&1 &
# nohup waitstart.sh -n trainScript_bert_MRPC "nohup ./trainScript_bert_MRPC_only_TIWR-H.sh > /dev/null 2>&1 &" > waitstart.log 2>&1 &
...
# all_times=(0.4)
seeds_of_stage1=(35 37 44 53 57)
